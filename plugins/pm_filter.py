...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>Your message has been sent to my moderators !</b>",
                             reply_markup=InlineKeyboardMarkup(
                                 [[
                                     InlineKeyboardButton('📍 Mᴏᴠɪᴇ ɪs ʜᴇʀᴇ 📍', url='https://t.me/HYBRID_MOVIES_CHAT')
                                 ]]
                             )
                             )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴏᴡɴ ɪɴғᴏ', url='https://t.me/Hybrid_Nations')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏ', url='https://github.com/Devil-Botz/GoYoonJung'),
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        try:
            if message.chat.id == SUPPORT_CHAT_ID:
                await message.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('Rᴇǫᴜᴇsᴛ ʜᴇʀᴇ 🚀', url='https://t.me/HYBRID_MOVIES_CHAT')
                        ]]
                    )
                )
            else:
        ...
        if re.search(pattern, name, flags=re.IGNORECASE):
            ...
            if btn is not None:
                try:
                    if fileid == "None":
                        if btn == "[]":
                            GoYoonJung = await client.send_message(
                                group_id,
                                reply_text,
                                disable_web_page_preview=True,
